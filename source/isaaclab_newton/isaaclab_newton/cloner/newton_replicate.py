...
def _bulk_add_homogeneous_worlds(
    ...
    builder._isaaclab_newton_homogeneous_clone = {
        ...
        "start_joint_idx": start_joint_idx,
        "start_joint_dof_idx": start_joint_dof_idx,
        "start_joint_coord_idx": start_joint_coord_idx,
        "start_articulation_idx": start_articulation_idx,
        "body_count": proto.body_count,
        "shape_count": proto.shape_count,
        "joint_count": proto.joint_count,
        "joint_dof_count": proto.joint_dof_count,
        "joint_coord_count": proto.joint_coord_count,
        "articulation_count": proto.articulation_count,
